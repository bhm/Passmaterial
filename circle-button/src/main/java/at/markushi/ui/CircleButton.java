...
public class CircleButton extends ImageView implements View.OnLongClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        circlePaint.setShadowLayer(10.0f, 0.0f, 3.5f, Color.argb(100, 0, 0, 0));

        focusPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        focusPaint.setStyle(Paint.Style.STROKE);

        pressedRingWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                DEFAULT_PRESSED_RING_WIDTH_DIP, getResources()
                        .getDisplayMetrics());
        ...
        if (attrs != null) {
            ...
            pressedRingWidth = (int) a.getDimension(R.styleable.CircleButton_cb_pressed_ring_width,
                    pressedRingWidth);
            a.recycle();
        }
