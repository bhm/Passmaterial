 ...
 */
public abstract class SequentialAdapter<T> extends BaseAdapter {
    ...
    protected SequentialAdapter(Context context) {
        this.context = context;
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public SequentialAdapter(Context context, List<T> data) {
        this(context);
